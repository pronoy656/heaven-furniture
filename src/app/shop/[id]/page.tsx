          ...
          <div className="lg:col-span-5 flex flex-col items-start text-left">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 w-full">
              ...
              <button
                ...
                className="flex-grow inline-flex items-center justify-center gap-2.5 rounded-full bg-[#163A2B] hover:bg-[#0f281e] text-white py-3.5 px-6 text-sm font-bold shadow-lg shadow-[#163A2B]/20 transition-all hover:-translate-y-0.5 cursor-pointer"
              >
