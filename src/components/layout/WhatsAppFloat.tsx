...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-brass text-charcoal-deep shadow-[0_8px_24px_rgba(0,0,0,0.35)] transition-transform duration-300 hover:scale-110"
    >
